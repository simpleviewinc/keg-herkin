...
module.exports = function () {
  this.When(/^I (click|doubleclick) on the (link|button|element) "([^"]*)?"$/, clickElement)
  this.When(/^I (add|set) "([^"]*)?" to the inputfield "([^"]*)?"$/, setInputField)
  this.When(/^I clear the inputfield "([^"]*)?"$/, clearInputField)
  this.When(/^I drag element "([^"]*)?" to element "([^"]*)?"$/, dragElement)
  this.When(/^I pause for (\d+)ms$/, pause)
  this.When(/^I set a cookie "([^"]*)?" with the content "([^"]*)?"$/, setCookie)
  this.When(/^I delete the cookie "([^"]*)?"$/, deleteCookies)
  this.When(/^I press "([^"]*)?"$/, pressButton)
  this.When(/^I (accept|dismiss) the (alertbox|confirmbox|prompt)$/, handleModal)
  this.When(/^I enter "([^"]*)?" into the prompt$/, setPromptText)
  this.When(/^I scroll to element "([^"]*)?"$/, scroll)
  this.When(/^I close the last opened (window|tab)$/, closeLastOpenedWindow)
  this.When(/^I focus the last opened (window|tab)$/, focusLastOpenedWindow)
